...
public class Main extends AppCompatActivity {
    ...
    protected void onActivityResult(int reqestCode, int resultCode, Intent data){
        ...
        Log.d(LT, "reqestCode = " + reqestCode + ", resultCode = " + resultCode);
