package ru.bitreslab.p1012_conprovclient;
...
public class Main extends AppCompatActivity {
    ...
    final Uri CONTACT_URI = Uri.parse("content://bit.ADDR_BOOK/contacts");
    ...
    public void onClickInsert(View v){
        ...
        Log.d(LT, "insert, result Uri: " + newUri.toString());
    }
    ...
    public void onClickUpdate (View v){
        ...
        Log.d(LT, "update, count = " + cnt);
    }

    public void onClickDelete(View v){
        Uri uri = ContentUris.withAppendedId(CONTACT_URI, 3);
        int cnt = getContentResolver().delete(uri, null, null);
        Log.d(LT, "delete, count = " + cnt);
    }

    public void onClickError(View v){
        Uri uri = Uri.parse("content://bit.ADDR_BOOK/phones");
        try{
            Cursor cursor = getContentResolver().query(uri, null, null, null, null);
        } catch (Exception ex){
            Log.d(LT, "Error: " + ex.getClass() + ", " + ex.getMessage());
        }
    }
}
