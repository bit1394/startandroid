package ru.bitreslab.p0531_simplecursortreeadapter;
...
public class DB {
    ...
    private class DBHelper extends SQLiteOpenHelper{
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String[] phonesSam = new String[]{"Galaxy S II", "Galaxy Nexus", "Wave"};
            ...
            for (int i = 0; i < phonesSam.length; i++) {
                cv.put(PHONE_COLUMN_COMPANY, 2);
                cv.put(PHONE_COLUMN_NAME, phonesSam[i]);
                db.insert(PHONE_TABLE, null, cv);
            }
