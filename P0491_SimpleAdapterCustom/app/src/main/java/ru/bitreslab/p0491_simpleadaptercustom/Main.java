package ru.bitreslab.p0491_simpleadaptercustom;
...
import static android.R.attr.submitBackground;

public class Main extends AppCompatActivity {
    final  String ATTRIBYTE_NAME_TEXT = "text";
    final  String ATTRIBYTE_NAME_VALUE = "value";
    final  String ATTRIBYTE_NAME_IMAGE = "image";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < values.length; i++){
            ...
            m.put(ATTRIBYTE_NAME_TEXT, "Day" + (i+1));
            m.put(ATTRIBYTE_NAME_VALUE, values[i]);
            ...
            m.put(ATTRIBYTE_NAME_IMAGE, img);
            data.add(m);
        }

        String[] from = {ATTRIBYTE_NAME_TEXT, ATTRIBYTE_NAME_VALUE, ATTRIBYTE_NAME_IMAGE};
